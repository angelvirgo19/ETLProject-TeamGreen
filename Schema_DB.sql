...
DROP TABLE IF EXISTS clean_us_pollution;
DROP TABLE IF EXISTS clean_air_emission_co;
DROP TABLE IF EXISTS clean_air_emission_no2;
DROP TABLE IF EXISTS clean_air_emission_so2;
